<script setup>
import { changeDir, changeInfo, userLoginService } from '@/api/user'
...
const onSubmit = async () => {
  ...
  const res = await changeInfo(userInfo.Identity, formModel.value)
  console.log(res)
  const res1 = await changeDir(userInfo.Identity, formModel.value.Direction)
  console.log(res1)
